    ...
    <section>
      <div className="container mx-auto p-5 w-full gap-10 text-2xl py-20">
        ...
        >
          ...
          the famous ‘Recoverworld Live’ brand all over the world and regularly
          features as a guest mixer on various dance stations including
          “Recoverworld Radio” which has now been broadcasting for over 20
          years…. In 2007 he released the mix album Dark Sessions which became
          Album of the Month in Mixmag and prompted Dj Mag to say, “this is
          trance at its most gorgeous”.
        </p>
        <h2
          data-scroll
          data-scroll-speed="1.5"
        ...
        >
          ...
          the world’s largest independent labels. He sold his share in 2018 but
          still uses it as the backbone for his guest lectures and his thriving
          label management business. His latest project, in partnership with{" "}
